...
const mutationKey = "salary-movement-reject" as const

type Props = {
  salaryMovements: SalaryMovementRequestItem[]
}
const SalaryMovementRejectButton = (props: Props) => {
          ...
          },
          {
            onSuccess: (res) => {
              ...
              toast({
                ...
                description: t(
                  `common.toast_messages.success.reject.salary.information.message`,
                  {
                    n: numberSuccess,
                  }
                ),
...
export default SalaryMovementRejectButton
